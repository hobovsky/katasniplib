...
`;
    ...
    function buildSnippetsDialog(lang, library, editor) {
        ...
        jQuery('body').append(`
            <div id='glotSnippetsDialog' title='Snippets Library for Python'>
                <div class="row">
                    ...
                    <div id="snippet_panel" class="column" style="padding: 10px">
                        <div id="sniplibcontent" class="markdown prose"/>
                        <a alt="View on GitHub" title="View on GitHub" id="showOnGithub" href="https://github.com/hobovsky/katasniplib/blob/main/content/snippets/" target="_blank">
        ...
        function presentSnippet(markdown) {
            ...
            jQuery('#snippet_panel').find('a').attr('target', '_blank');
